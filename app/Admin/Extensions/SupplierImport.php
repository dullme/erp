    ...
    public function render()
    {
        ...
        return "<div class=\"btn-group \" style=\"margin-right: 10px\">
                    ...
                    <ul class=\"dropdown-menu\" role=\"menu\">
                        ...
                        <li><a id='touch' style='display: block;padding: 3px 20px;clear: both;font-weight: 400;line-height: 1.42857143;white-space: nowrap;cursor: pointer;color: #777;' >生产商导入</a><input id='user_info' type='file' name='user_info' accept='.xls, .xlsx' style='display: none'></li>
                    </ul>
               </div>";
    }
